...
def build_parser() -> argparse.ArgumentParser:
    ...
    pe = sub.add_parser("enc", help="encode xor: default ysbin_dec -> ysbin_enc")
    pe.add_argument("target", nargs="?", default="ysbin_dec", help="input file or directory (default: ysbin_dec)")
