...
public sealed class ScrInstructionTextCodec
{
    ...
    public bool TryRead(ScriptDocument script, string line, int lineNo)
    {
        ...
        switch (tokens[0])
        {
            ...
            case "date_place_reset":
                ...
                return true;
            case "save":
                script.AddInstruction(25, BuildTargetBody(tokens, lineNo), targetLabel: ReadTargetLabel(tokens, lineNo));
                return true;
            case "follow_jump":
    ...
    private byte[] BuildAssignBody(IReadOnlyList<string> tokens, int lineNo)
    {
        ...
        WriteI32(body, 0, ReadI32(values, "dst", lineNo));
