...
{
    public static void AttachInstructionLabels(ScriptDocument script)
    {
    ...
    public static void MaterializeInstructionTargets(ScriptDocument script)
    {
        ...
        foreach (var instruction in script.Instructions.ToList())
        {
            ...
            BinaryPrimitives.WriteUInt32LittleEndian(instruction.Body.AsSpan(operandOffset, 4), checked((uint)offset));
        }
    }
