...
// 被依赖: InteractiveSession (export/import 命令)
// ============================================================================
using System.Text;
...
public sealed class MessageWorkflowProcessor
{
    private readonly MessagePlaceholderConfig _config;

    public MessageWorkflowProcessor(MessagePlaceholderConfig config)
    {
        _config = config;
    }
