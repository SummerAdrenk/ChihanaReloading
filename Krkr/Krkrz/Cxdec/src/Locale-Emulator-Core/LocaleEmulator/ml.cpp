...
// VS2022 cannot link this project with the original LTCG settings and legacy
// delayimp.lib. Emit ml.cpp's ForceInline implementations as normal external
// symbols so other translation units can link without LTCG.
#undef ForceInline
#define ForceInline
